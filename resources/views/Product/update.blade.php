...
<body>
    ...
    <form action="/product/submit-update" method="post">
        ...
        <input type="text" name="updated_name" placeholder="Product's Name" value="{{$data[0] -> name}}"><br><br>
        <label for="">Quantity : </label>
        <input type="text" name="updated_qty" placeholder="Product's Qty "  value="{{$data[0] -> qty}}"><br><br>
